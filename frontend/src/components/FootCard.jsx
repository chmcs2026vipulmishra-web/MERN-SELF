    ...
    <>
      ...
      >
        ...
        <div className="flex text-[12px] justify-between items-start">
          ...
          <span className="inline-flex items-center rounded-md bg-green-400/10 px-2 py-1 text-xs font-medium text-green-400 inset-ring inset-ring-green-500/20">{footwear.category}</span>
        </div>
        ...
        <div className="mt-4 space-y-2">
          ...
          <div className="flex items-center gap-5">
            ...
            <p className="text-[25px] font-bold text-base-content">
              {footwear.type}
            </p>
          </div>
          ...
          {/* Size */}
          <p className="flex items-center gap-3 text-[18px] font-semibold text-base-content">
            <Ruler className="size-6 text-blue-600" />
            Size: {footwear.size}
          </p>
        ...
        <div className="mt-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative group">
              <Edit2 className="size-5 text-warning hover:scale-110 transition cursor-pointer" />
              <span
                className="absolute -top-8 left-1/2 -translate-x-1/2 bg-warning text-white text-xs rounded px-2 py-1 opacity-0 group-hover:opacity-100 transition duration-200"
              >
                Edit
              </span>
            </div>
            ...
            <div className="relative group">
              ...
              <span
                className="absolute -top-8 left-1/2 -translate-x-1/2 bg-error text-white text-xs rounded px-2 py-1 opacity-0 group-hover:opacity-100 transition duration-200"
              >
                Delete
              </span>
            </div>
